describe('Credito sin garantía', function () {
    ...
    */
    ...
    it('credito sin garantía', () => {
        ...
        cy.wait(5000);
        //iniciar sesion
        cy.get('.v-toolbar__items > [href="/login"] > .v-btn__content').click({force:true});
        cy.wait(5000);
        //rut
        cy.get('.justify-center > .container > .layout > :nth-child(1) > .dni-field > .v-input > .v-input__control > .v-input__slot > .v-text-field__slot').type('184637561');
        cy.wait(5000);
        //contraseña
        cy.get('.justify-center > .container > .layout > :nth-child(2) > .v-input > .v-input__control > .v-input__slot > .v-text-field__slot > input').type('L_123450');
        cy.wait(5000);
        //ingresar
